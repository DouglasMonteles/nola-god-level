...
--changeset douglasmonteles:01-create-initial-database
...
-- rollback DROP TABLE sub_brands;
-- rollback DROP TABLE stores;
-- rollback DROP TABLE channels;
-- rollback DROP TABLE categories;
-- rollback DROP TABLE products;
-- rollback DROP TABLE option_groups;
-- rollback DROP TABLE items;
-- rollback DROP TABLE customers;
-- rollback DROP TABLE sales;
-- rollback DROP TABLE product_sales;
-- rollback DROP TABLE item_product_sales;
-- rollback DROP TABLE item_item_product_sales;
-- rollback DROP TABLE delivery_sales;
-- rollback DROP TABLE delivery_addresses;
-- rollback DROP TABLE payment_types;
-- rollback DROP TABLE payments;
-- rollback DROP TABLE coupons;
-- rollback DROP TABLE coupon_sales;